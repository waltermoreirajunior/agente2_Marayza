...
const ChatBot = () => {
  ...
  const generateBotResponse = (userMessage) => {
    ...
    if (message.includes('horário') || message.includes('funcionamento') || message.includes('aberto')) {
      return `🕐 Horário de Funcionamento\n\n• Segunda e Quarta: 07:00h às 11:00h e 14:00h às 20:00h\n• Terça e Quinta: 06:00h às 10:00h e 14:00h às 20:00h\n\n📍 Estamos sempre prontos para atendê-lo(a)!`;
    }
    ...
    if (message.includes('tchau') || message.includes('obrigado') || message.includes('obrigada')) {
      return "Foi um prazer ajudá-lo(a)! 😊 Estamos sempre aqui quando precisar. Tenha um ótimo dia e esperamos vê-lo(a) em breve no Studio!";
    }
    
    // Resposta padrão
    return `Entendi! Como um robô, estou aprendendo e melhorando para aprimorar nossa experiência de atendimento. Posso ajudar com:\n\n• Informações sobre serviços\n• Agendamentos\n• Horários\n• Localização\n• Valores\n\nOu se preferir, pode entrar em contato:\n📞 (64) 99233-4004\n💬 WhatsApp: (64) 99233-4004\n\nComo posso ajudar?`;
  };
      ...
      <div className="bg-blue-50 p-4 border-b">
        <div className="flex flex-wrap gap-6 text-sm text-blue-800">
          <div className="flex items-center gap-2">
            <Clock size={16} />
            <span>Seg e Qua: 7h-11h | 14h-20h</span>
          </div>
          <div className="flex items-center gap-2">
            <Phone size={16} />
            <span>(64) 99233-4004</span>
          </div>
          <div className="flex items-center gap-2">
            <Calendar size={16} />
